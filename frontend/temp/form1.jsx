...
function Form1() {
  ...
  const [teamMembers, setTeamMembers] = useState([
    { name: "", classGroup: "", mobile: "", expertise: "", role: "" },
  ]);
      ...
      <div className="max-w-6xl mx-auto bg-white p-8 rounded-xl shadow">
        <div className="mb-10 text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-700 mt-2">
            MAJOR / MINOR PROJECT ABSTRACT (2023-24)
          </h2>
        </div>
          ...
          <div>
            ...
            <div className="space-y-2 ml-4">
              <label className="block">
                <input type="checkbox" /> R&D (Innovation)
              </label>
              <label className="block">
                <input type="checkbox" /> Consultancy (Industry)
              </label>
              <label className="block">
                <input type="checkbox" /> Startup (Self-Business)
              </label>
              <label className="block">
                <input type="checkbox" /> Project Pool (IBM/Infosys)
              </label>
              <label className="block">
                <input type="checkbox" /> Hardware / Embedded
              </label>
            </div>
          </div>
                  ...
                  <tr key={i}>
                    ...
                    <td className="border px-2 py-1">
                      <input
                        ...
                        value={tool.version}
                        onChange={(e) =>
                          handleToolChange(i, "version", e.target.value)
                        }
                      />
                    </td>
                    <td className="border px-2 py-1">
                      <input
                        ...
                        value={tool.type}
                        onChange={(e) =>
                          handleToolChange(i, "type", e.target.value)
                        }
                      />
                    </td>
                    <td className="border px-2 py-1">
                      <input
                        ...
                        value={tool.purpose}
                        onChange={(e) =>
                          handleToolChange(i, "purpose", e.target.value)
                        }
                      />
                    </td>
                    <td className="border px-2 py-1 text-center">
                      <button
                        type="button"
                        onClick={() => deleteToolRow(i)}
                        className="mt-1 px-4 py-1 bg-red-500 hover:bg-red-600 text-white rounded cursor-pointer"
                      >
                        Delete
                      </button>
                    </td>
                  ...
                  <tr key={i}>
                    ...
                    <td className="border px-2 py-1">
                      <input
                        ...
                        onChange={(e) =>
                          handleModuleChange(i, "functionality", e.target.value)
                        }
                      />
                    </td>
                    <td className="border px-2 py-1 text-center">
                ...
                {teamMembers.map((member, i) => (
                  <tr key={i}>
                    ...
                    <td className="border px-2 py-1">
                      <input
                        className="w-full p-1"
                        value={member.classGroup}
                        onChange={(e) =>
                          handleMemberChange(i, "classGroup", e.target.value)
                        }
                      />
                    </td>
                    <td className="border px-2 py-1">
                      <input
                        ...
                        value={member.mobile}
                        onChange={(e) =>
                          handleMemberChange(i, "mobile", e.target.value)
                        }
                      />
                    </td>
                    <td className="border px-2 py-1">
                      <input
                        ...
                        onChange={(e) =>
                          handleMemberChange(i, "expertise", e.target.value)
                        }
                      />
                    </td>
                    <td className="border px-2 py-1">
