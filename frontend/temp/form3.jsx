...
function Form3() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen py-10 px-4">
      <div
        id="form3-content"
        className="max-w-6xl mx-auto bg-white p-8 rounded shadow"
      >
        <h1 className="text-2xl font-bold mb-4">
          PROJECT WEEKLY STATUS MATRIX [Form-3]
        </h1>
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          {teamMembers.map((member, idx) => (
            <input
              ...
              placeholder={`Other Team Member ${idx + 2}`}
              value={member}
              onChange={(e) => {
              ...
              <tr key={i}>
                <td className="border px-2 py-1">
                  <div className="flex gap-1">
                    <input
                      ...
                      value={week.from}
                      onChange={(e) =>
                        handleWeeklyChange(i, "from", e.target.value)
                      }
                    />
                    <input
                      type="date"
                      ...
                      value={week.to}
                      onChange={(e) =>
                        handleWeeklyChange(i, "to", e.target.value)
                      }
                    />
                  </div>
                </td>
                <td className="border px-2 py-1">
                  <input
                    ...
                    value={week.module}
                    onChange={(e) =>
                      handleWeeklyChange(i, "module", e.target.value)
                    }
                  />
                </td>
                <td className="border px-2 py-1">
                  <input
                    ...
                    value={week.progress}
                    onChange={(e) =>
                      handleWeeklyChange(i, "progress", e.target.value)
                    }
                  />
                </td>
                <td className="border px-2 py-1">
                  <input
                    ...
                    value={week.comments}
                    onChange={(e) =>
                      handleWeeklyChange(i, "comments", e.target.value)
                    }
                  />
                </td>
                <td className="border px-2 py-1">
                  <input
                    ...
                    value={week.marks}
                    onChange={(e) =>
                      handleWeeklyChange(i, "marks", e.target.value)
                    }
                  />
                </td>
                <td className="border px-2 py-1 text-center">
                  <button
                    onClick={() => deleteWeekRow(i)}
